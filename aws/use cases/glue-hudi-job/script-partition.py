...
args = getResolvedOptions(sys.argv, ['JOB_NAME','tablename','pk_col','precombine_field','partition_field','load_type'])
...
partitionDataConfig = {'hoodie.datasource.write.partitionpath.field': partition_field, 'hoodie.datasource.hive_sync.partition_extractor_class': 'org.apache.hudi.hive.MultiPartKeysValueExtractor', 'hoodie.datasource.hive_sync.partition_fields': partition_field}

if(load_type == 'UPSERT'):
    combinedConf = {**commonConfig, **partitionDataConfig, **loadconfig}
else:
